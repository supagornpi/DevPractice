 ...
 */
class CustomIconCreator : SettingViewHolderFactory.Creator {
    override fun create(parent: ViewGroup): RecyclerView.ViewHolder {
        return ToggleViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.layout_setting_custom_icon, parent, false))
    }
}