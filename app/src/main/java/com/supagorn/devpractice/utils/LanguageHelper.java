...
public class LanguageHelper {
    private static final String SELECTED_LANGUAGE = "ChangeLanguage.Helper.Selected.ChangeLanguage";
    ...
    public static int getLanguageIcon() {
        return Locale.getDefault().getLanguage().equalsIgnoreCase(TH) ?
                R.drawable.img_setting_flag_thai : R.drawable.img_setting_flag_english;
    }
